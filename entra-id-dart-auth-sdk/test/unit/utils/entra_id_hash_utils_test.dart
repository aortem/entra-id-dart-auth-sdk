...
void main() {
  group('EntraIdHashUtils', () {
    test('should hash data using SHA256', () {
      ...
      final hash = EntraIdHashUtils.hashSHA256(input);
    ...
    test('should produce consistent hash for the same input', () {
      ...
      final hash1 = EntraIdHashUtils.hashSHA256(input);
      final hash2 = EntraIdHashUtils.hashSHA256(input);
    ...
    test('should validate hashed data successfully', () {
      ...
      final hash = EntraIdHashUtils.hashSHA256(input);
      final isValid = EntraIdHashUtils.validateSHA256(input, hash);
    ...
    test('should return false for invalid hashed data', () {
      ...
      final hash = EntraIdHashUtils.hashSHA256(input);
      final isValid = EntraIdHashUtils.validateSHA256('wrong_data', hash);
