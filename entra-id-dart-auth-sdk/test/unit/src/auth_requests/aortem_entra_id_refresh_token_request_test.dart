...
import 'package:entra_id_dart_auth_sdk/src/auth_requests/aortem_entra_id_refresh_token_request.dart'; // Adjust the import to your actual file

void main() {
  group('AortemEntraIdRefreshTokenRequest', () {
    test('should throw an error on failed token refresh', () async {
      ...
      final refreshTokenRequest = AortemEntraIdRefreshTokenRequest(
