...
class AortemEntraIdDeserializer {
  ...
  /// 
  /// Returns:
  ///   Map<String, dynamic>: The deserialized token data.
  ...
  /// 
  /// Returns:
  ///   Map<String, dynamic>: The deserialized user profile data.
  static Map<String, dynamic> deserializeUserProfileResponse(String jsonResponse) {
    try {
      final Map<String, dynamic> data = json.decode(jsonResponse);

      // Check for required fields
      if (!data.containsKey('id') || !data.containsKey('displayName')) {
        throw FormatException("Missing required fields in user profile response.");
      }
  ...
  static T deserializeResponse<T>(String jsonResponse, T Function(Map<String, dynamic>) fromJson) {
    try {
      final Map<String, dynamic> data = json.decode(jsonResponse);
  ...
  /// 
  /// Returns:
  ///   Map<String, dynamic>: The deserialized error data.
